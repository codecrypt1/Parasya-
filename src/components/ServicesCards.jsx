...
const ServicesCards = () => {
  return (
    ...
    >
      <div className=" flex flex-col items-center my-10">
        ...
        <div className="grid grid-cols-1   md:w-3/5 items-end  h-auto bg-green mx-3 mt-8  md-grid-col-4 gap-4">
          <p className="text-xl text-center font-serif text-gray-400 mx-4  ">
            Welcome to studenthub Connect, your all-in-one platform designed
      ...
      <div className=" grid grid-cols-1 gap-7 pl-10 mx-8 mt-10 pb-6 md:grid-cols-2 lg:grid-cols-3">
        {/*  */}
        {/* <div class="HomeCard1">
          <a href="/shop">
